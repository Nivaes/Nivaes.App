...
//            var buffer = ProtoHelper.Serialize(modelTest1);
//            buffer.Should().NotBeNull();

//            mTestOutputHelper.WriteLine($"Serialization size: {buffer.Length}");

//            var modelTest2 = ProtoHelper.Deserialize<ModelTest1>(buffer);
...
//            var modelTest2 = ProtoHelper.Deserialize<ModelTest2>(buffer);
...
//            var modelTest2 = ProtoHelper.Deserialize<ModelTest3>(buffer);
...
//            var modelTest2 = ProtoHelper.Deserialize<TestDataModel01>(buffer);
