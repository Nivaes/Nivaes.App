namespace Nivaes.App
{
    ...
    public static class ProtoBufHelper2
    {
        public static RuntimeTypeModel Default { get; }

        static ProtoBufHelper2()
        {
        ...
        public static T Deserialize<T>(byte[] payload)
        {
            try
            {
                ...
                {
                    var aa = ProtoBufHelper2.Default.Deserialize(ms, null, typeof(T));

                    //var aa = System.Runtime.Serialization.FormatterServices.GetUninitializedObject(typeof(T));
                    //var cc = ProtoBufHelper2.Default.Deserialize(ms, aa, typeof(T));
